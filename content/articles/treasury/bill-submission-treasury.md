...
summary: "How to prepare and submit contingent and other bills to treasury — sanctions, heads of account, and tracking."
telugu_summary: "Treasury ku bill submission — sanctions, head of account మరియు tracking."
telugu_overview: "Contingent bill correct head of account మరియు vouchers తో సిద్ధం చేయండి. administrative మరియు financial sanctions record లో verify చేయండి. assigned treasury ద్వారా submit చేసి CFMS లో bill status track చేయండి."
status: published
